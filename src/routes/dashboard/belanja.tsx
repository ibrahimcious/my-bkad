...
export const Route = createFileRoute('/dashboard/belanja')({
  loader: async () => {
  ...
  component: BelanjaDashboard,
  pendingComponent: BelanjaPending,
})

function BelanjaDashboard() {
    ...
    return (
      <div className="rounded-card border border-fog bg-snow p-10 text-center">
        <p className="text-sm text-steel">
          Belum ada data LRA Belanja. Silakan unggah berkas pada halaman
          administrasi.
        </p>
      </div>
    )
